...
<div class="max-w-4xl mx-auto space-y-8">
    <div>
        <h2 class="font-serif text-4xl font-bold text-dark-brown">Tambah Owner</h2>
        <p class="text-gray-500 mt-2 text-lg">Buat akun owner baru untuk mengelola cafe.</p>
    </div>
    ...
    <div class="bg-white rounded-[2rem] shadow-lg border border-light-beige/30 p-10">
        ...
        <form action="{{ route('admin.owners.store') }}" method="POST" class="space-y-6">
            ...
            <div class="flex gap-4 pt-6">
                <button type="submit" class="bg-dark-brown text-white px-8 py-4 rounded-full font-bold hover:opacity-90 transition">Simpan Owner</button>

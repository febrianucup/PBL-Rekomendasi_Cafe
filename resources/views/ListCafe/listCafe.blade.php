...
<body class="text-gray-900 min-h-screen flex flex-col">
    ...
    <main class="flex-grow w-full max-w-7xl mx-auto px-6 py-12 flex flex-col">
        ...
        <section class="w-full h-[300px] md:h-[300px] mb-24 overflow-hidden rounded-3xl relative group bg-gray-200 shadow-xs"
        x-data='{ 
            activeSlide: 0,
            slides: [

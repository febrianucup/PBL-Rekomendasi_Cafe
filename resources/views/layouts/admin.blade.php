    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-64 bg-white shadow-xl shadow-light-beige/50 z-20 flex flex-col justify-between" x-data="{ currentRoute: '{{ request()->path() }}' }">
            ...
            <div class="p-6 space-y-2 border-t-2 border-cream">
                <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-500 hover:bg-cream hover:text-dark-brown transition-all duration-300">
                ...
                <a href="#" class="flex items-center gap-3 px-4 py-3 rounded-2xl text-gray-500 hover:bg-cream hover:text-dark-brown transition-all duration-300">
                 ...
                 <div class="mt-4 pt-4 border-t-2 border-cream flex items-center gap-3 px-2">
                    <div class="h-10 w-10 rounded-full bg-light-beige overflow-hidden ring-2 ring-offset-2 ring-white flex-shrink-0">
                        <img src="https://ui-avatars.com/api/?name=Admin+User&background=D6CFC7&color=4B2E2B" alt="Admin" class="h-full w-full object-cover">
                    </div>
                    <div class="text-sm truncate">
                        <p class="font-semibold tracking-tight text-dark-brown">Admin User</p>
        ...
        <main class="flex-1 flex flex-col h-screen overflow-hidden">
            ...
            <header class="h-24 px-12 flex items-center justify-between">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <!-- Topbar Profile (Optional as it's in sidebar now, but matching request) -->
                    <div class="hidden lg:flex items-center gap-3 bg-white pl-2 pr-4 py-1.5 rounded-full shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] border border-light-beige/20 cursor-pointer hover:shadow-md transition-all">
